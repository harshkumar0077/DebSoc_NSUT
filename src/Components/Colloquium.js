...
<div className="event-info">
    ...
    <div className="col-sm-6 col-xs-6 col-md-6 col-lg-6 position">
<a target="_blank" className="button1 a vv" href="https://forms.gle/f9EWBkvd1DYAb5Us6"style={{color: '#fff !important'}}>Register as a Delegate</a>
                     </div>
  </div>
  <div className="event-img-wrapper">
...
<div className="event-card">
  <div className="event-info">
      ...
      <div className="col-sm-6 col-xs-6 col-md-6 col-lg-6 position">
  <a className="button1 a vv1" href="https://forms.gle/vLZXAMXQR1i1Vxdm8"style={{color: '#fff !important'}}>Register For NSMCD</a>
                       </div>
    </div>
    <div className="event-img-wrapper">
      <img
        src="./images/events/nsmcd.png"
  ...
  <div className="event-card">
    ...
    <div className="event-info">
      ...
      <div className="col-sm-6 col-xs-6 col-md-6 col-lg-6 position">
  <a className="button1 a" href="https://docs.google.com/forms/d/e/1FAIpQLSeE_w0g1i3c2RqMjNBr0CLDX6JkjK8lo2jQ7tI7JOoFmJCeoQ/viewform" style={{color: '#fff !important'}}>Register Now!</a>
                       </div>
    </div>
  </div>
...
<div className="event-info">
    ...
    <div className="col-sm-6 col-xs-6 col-md-6 col-lg-6 position">
<a className="button1 a " href=" https://dare2compete.com/competition/in-case-you-can-colloquium-netaji-subhas-university-of-technology-nsut-delhi-274683"style={{color: '#fff !important'}}>Register Now!</a>
                     </div>
  </div>
  <div className="event-img-wrapper">
    <img src="./images/events/icyc.png" alt="event" className="event-image startupcombat" />
  </div>
  ...
  <div className="event-card">
    <div className="event-img-wrapper">
      <img
        src="./images/events/Fandemic.png"
    ...
    <div className="event-info">
      ...
      <div className="col-sm-6 col-xs-6 col-md-6 col-lg-6 position">
  <a className="button1 a" href="https://dare2compete.com/creative-cultural-event/fandemic-colloquium-netaji-subhas-university-of-technology-nsut-delhi-275402"style={{color: '#fff !important'}}>Register Now!</a>
                       </div>
    </div>
  </div>
  <div className="event-card">
  <div className="event-info">
      ...
      <div className="col-sm-6 col-xs-6 col-md-6 col-lg-6 position">
  <a className="button1 a" href=" https://dare2compete.com/creative-cultural-event/drunk-history-colloquium-netaji-subhas-university-of-technology-nsut-delhi-275296"style={{color: '#fff !important'}}>Register Now!</a>
                       </div>
    </div>    <div className="event-img-wrapper">
      <img
        src="./images/events/dh.png"
  ...
  <div className="event-card">
    ...
    <div className="event-info">
      ...
      <div className="col-sm-6 col-xs-6 col-md-6 col-lg-6 position">
  <a className="button1 a" href=" https://dare2compete.com/creative-cultural-event/knack-for-a-whack-colloquium-netaji-subhas-university-of-technology-nsut-delhi-275495"style={{color: '#fff !important'}}>Register Now!</a>
                       </div>
    </div>
  </div>
